...
package getfood.io.data.network;
...
import getfood.io.data.network.auth.Authentication;
import getfood.io.data.network.auth.HttpBasicAuth;
import getfood.io.data.network.auth.ApiKeyAuth;
import getfood.io.data.network.auth.OAuth;
...
public class ApiClient {
    ...
    public String selectHeaderAccept(String[] accepts) {
        ...
        return getfood.io.util.StringUtil.join(accepts, ",");
    }
